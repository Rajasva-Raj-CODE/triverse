...
const quickActions = [
  { label: "Add Project", href: "/company-dashboard/projects", icon: Plus },
  { label: "Add Camera", href: "/company-dashboard/cameras", icon: Plus },
  { label: "Manage Users", href: "/company-dashboard/users", icon: Users },
  { label: "Assign Role", href: "/company-dashboard/roles", icon: ShieldCheck },
  { label: "Enable Features", href: "/company-dashboard/assign", icon: Activity },
  { label: "Settings", href: "/company-dashboard/settings", icon: LayoutDashboard },
];
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
        ...
        <Card className="rounded-2xl border-[#FF9A00]/40 dark:border-[#FF9A00]/30 bg-gradient-to-br from-[#FF9A00]/20 to-[#FFD93D]/20 dark:from-[#FF9A00]/20 dark:to-[#FFD93D]/20 shadow-sm">
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div className="space-y-1">
                <p className="text-sm font-medium text-[#FF9A00] dark:text-[#FFD93D]">
                  Active Sessions
                </p>
                <p className="text-2xl font-bold text-[#4F200D] dark:text-[#F6F1E9]">1,234</p>
                <p className="text-xs text-[#FF9A00] dark:text-[#FFD93D] flex items-center gap-1">
                  <Activity className="h-3 w-3 text-[#FF9A00] dark:text-[#FFD93D]" />
                  <span className="text-[#FF9A00] dark:text-[#FFD93D]">+12.3%</span> from last week
                </p>
              </div>
              <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-[#FF9A00]/20 dark:bg-[#FFD93D]/30">
                <Activity className="h-6 w-6 text-[#FF9A00] dark:text-[#FFD93D]" />
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div className="space-y-1">
                ...
                <p className="text-2xl font-bold text-[#4F200D] dark:text-[#F6F1E9]">3.24%</p>
                <p className="text-xs text-[#FF9A00] dark:text-[#FFD93D] flex items-center gap-1">
                  <ChartPie className="h-3 w-3 text-[#FF9A00] dark:text-[#FFD93D]" />
                  <span className="text-[#FF9A00] dark:text-[#FFD93D]">+0.5%</span> from last month
                </p>
              </div>
              <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-[#FF9A00]/20 dark:bg-[#FFD93D]/30">
                <ChartPie className="h-6 w-6 text-[#FF9A00] dark:text-[#FFD93D]" />
              </div>
            </div>
          </CardContent>
        </Card>
