...
import { Globe, MousePointer, Box, Eye, Navigation } from "lucide-react";
import { Button } from "@/components/ui/button";

const features = [
  { icon: Globe, text: "Crystal-Clear 360° images" },
  { icon: MousePointer, text: "Clickable Info Points" },
  { icon: Box, text: "VR-Ready Virtual Tours" },
  { icon: Eye, text: "Realistic Depth & Spatial Awareness in VR" },
  { icon: Navigation, text: "Seamless VR Navigation" },
];
      ...
      <div className="max-w-7xl px-4 md:px-6 mx-auto grid grid-cols-1 xl:grid-cols-5 gap-12 items-center">
        ...
        >
          <div className="relative group">
            ...
            <div className="relative rounded-2xl overflow-hidden border border-brand-border-light shadow-xl">
              <video
                src="/landing_page/videos/VT.mp4"
                autoPlay
                loop
                muted
                playsInline
        ...
        >
          ...
          <p className="text-base md:text-lg text-muted-foreground mb-8 max-w-2xl leading-relaxed">
            Triverse delivers high-resolution 360° Virtual Tours that let users explore real-world spaces remotely through an intuitive, browser-based experience, no apps required. Ideal for construction, real estate, and education, these tours feature interactive hotspots and lifelike navigation.
          </p>
