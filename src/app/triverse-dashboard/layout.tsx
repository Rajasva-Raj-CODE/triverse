...
const sidebarMenuItems = [
    ...
    items: [
      {
        ...
        url: "/triverse-dashboard/companies-access",
        icon: Building2,
      },
      {
        title: "Company Super Admins",
        url: "/triverse-dashboard/company-super-admins",
        icon: Shield,
      },
      {
        title: "Projects",
        url: "/triverse-dashboard/projects",
        icon: Folder,
      },
      {
        title: "Cameras",
        url: "/triverse-dashboard/cameras",
        icon: Camera,
      },
      {
        title: "Users Management",
        url: "/triverse-dashboard/users",
        icon: Users,
      },
      {
        title: "Roles & Permissions",
        url: "/triverse-dashboard/roles&permissions",
        icon: Shield,
      },
    ],
  },
  ...
  },
  {
    ...
    items: [
      {
        title: "My Profile",
        url: "/triverse-dashboard/profile",
        icon: UserRound,
      },
      {
        title: "System Settings",
        url: "/triverse-dashboard/settings",
        icon: Settings,
      },
    ],
  },
          ...
          <DropdownMenuContent align="end" className="w-56 bg-white dark:bg-[var(--brand-bg-primary)]/95 backdrop-blur border border-[var(--brand-border-medium)] dark:border-[var(--brand-border)]">
            <div className="flex items-center gap-3 px-2 py-1.5">
              ...
              <div className="flex flex-col gap-0.5">
                <p className="text-sm font-medium text-[var(--brand-text-primary)] dark:text-[var(--brand-text-primary)]">Super Admin</p>
                <p className="text-xs text-[var(--brand-primary)] dark:text-[var(--brand-text-secondary)]">
                  admin@triverse.com
                </p>
              </div>
            ...
            <DropdownMenuItem asChild className="text-[var(--brand-text-primary)] dark:text-[var(--brand-text-primary)] hover:bg-[var(--brand-primary)]/30 dark:hover:bg-[var(--brand-primary)]/30">
              <Link
                href="/triverse-dashboard/profile"
            ...
            <DropdownMenuItem asChild className="text-[var(--brand-text-primary)] dark:text-[var(--brand-text-primary)] hover:bg-[var(--brand-primary)]/20 dark:hover:bg-[var(--brand-primary)]/30">
              <Link
                href="/triverse-dashboard/settings"
                className="flex items-center gap-2"
              >
